...
namespace Peep.Tests.API.Unit.Services
{
    ...
    public class HostedCrawlerServiceTests
    {
        ...
        public async Task Execute_Completes_When_CancellationToken_Cancelled()
        {
            ...
            var service = new HostedCrawlerService(context, logger, mockCrawler.Object, nowProvider);
        ...
        public async Task Uses_Crawler_When_Job_Found()
        {
            ...
            var mockCrawler = new Mock<ICrawler>();
            mockCrawler.Setup(mock => mock.Crawl(It.IsAny<CrawlJob>(), It.IsAny<CancellationToken>()))
            ...
            await service.StopAsync(cancellationTokenSource.Token);
            mockCrawler.Verify(mock => mock.Crawl(It.IsAny<CrawlJob>(), It.IsAny<CancellationToken>()), Times.Once());
        }
