...
{
    public class PushCrawlDataHandler : IRequestHandler<PushCrawlDataRequest, Either<Unit, ErrorResponseDTO>>
    {
        ...
        public async Task<Either<Unit, ErrorResponseDTO>> Handle(PushCrawlDataRequest request, CancellationToken cancellationToken)
        {
